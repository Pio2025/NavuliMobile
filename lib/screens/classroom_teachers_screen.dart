...
class ClassroomTeachersScreen extends StatefulWidget {
  final int classId;

  const ClassroomTeachersScreen({super.key, required this.classId});

  @override
  State<ClassroomTeachersScreen> createState() => _ClassroomTeachersScreenState();
}

class _ClassroomTeachersScreenState extends State<ClassroomTeachersScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: _loading
            ...
            : _error != null
                ? Center(child: Text('Failed to load teachers: $_error'))
                : RefreshIndicator(
                    onRefresh: _load,
                    child: ListView(
                      padding: const EdgeInsets.all(16),
                      children: [
                        _roleTile('Class Teacher', 'Class Teacher'),
                        _roleTile('Assistant Class Teacher', 'Assistant Class Teacher'),
                      ],
                    ),
                  ),
      ),
