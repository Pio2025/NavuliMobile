...
int _asInt(dynamic v) => _asNum(v).round();
...
class _ExamReportCardScreenState extends State<ExamReportCardScreen> {
  ...
  Future<Uint8List> _buildPdf() async {
    ...
    final statItems = <List<String>>[
      ...
      ['PASS %', '${_asInt(_stats['pct_pass'] ?? 0)}%'],
      ['CLASS AVG', _stats['avg_score'] != null ? '${_asInt(_stats['avg_score'])}%' : '-'],
    ];

    final generatedLine =
        'Generated by Navuli Fiji School Management System - Mobile App - on ${_fmtDateTime(DateTime.now())}.';
                ...
                children: [
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Column(
                        children: [
                          pw.Text('${totalE.round()} / ${totalP.round()}',
                ...
                children: [
                  ...
                  pw.TableRow(
                    ...
                    children: [
                      ...
                      _td('${totalE.round()}', bold: true, align: pw.TextAlign.center),
                      _td('${totalP.round()}', bold: true, align: pw.TextAlign.center),
                      _td(ovPct != null ? '${ovPct.round()}%' : '-', bold: true, align: pw.TextAlign.center),
  ...
  pw.TableRow _markRow(Map<String, dynamic> m) {
    ...
    final mg = mp != null ? _grade(mp.toDouble()) : '-';
    return pw.TableRow(children: [
      _td('${m['subject_name'] ?? ''}'),
      _td(mark != null ? '${_asInt(mark)}' : '-', align: pw.TextAlign.center, bold: true),
      _td(m['total_mark'] != null ? '${_asInt(m['total_mark'])}' : '', align: pw.TextAlign.center),
        ...
        children: [
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Text('${totalE.round()} / ${totalP.round()}',
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('${totalE.round()} / ${totalP.round()}  ·  ${ovPct != null ? '${ovPct.round()}%' : '—'}'
                    '${grade != null ? '  ·  $grade' : ''}',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            mark != null ? '${_asInt(mark)} / ${_asInt(m['total_mark'])} (${mp ?? '—'}%)' : 'Not recorded',
  ...
  Widget _classStatsStrip(ColorScheme scheme) {
    ...
    final items = <List<String>>[
      ...
      ['PASS %', '${_asInt(st['pct_pass'] ?? 0)}%'],
      ['CLASS AVG', st['avg_score'] != null ? '${_asInt(st['avg_score'])}%' : '—'],
    ];
    return _card(
      scheme,
      Column(
